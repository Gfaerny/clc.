...
int main()
{
    ...
    RGFW_window *RGFW_window_obj = RGFW_createWindow(
        "clc.", 0, 0, 500, 300, RGFW_windowOpenGL | RGFW_windowNoBorder | RGFW_windowNoResize | RGFW_windowCenter);
    ...
    while (RGFW_window_shouldClose(RGFW_window_obj) == false)
    {
        ...
        if (order_time_stop)
        {
            ...
            glyph_renderer_draw_text(&renderer, t_str.c_str(), 170.0f, 350.0f, 1.0f, 1.0f, 1.0f, 1.0f,
                                     GLYPH_EFFECT_NONE);
        }
